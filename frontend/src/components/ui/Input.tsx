...
const Input = (props: InputProps) => {
  ...
  const variants = {
    primary:
      'border-2 border-nav-stroke rounded-2xl px-4 py-2.5 w-full transition-all duration-200 focus:border-accent-green focus:shadow-sm placeholder:text-text-muted placeholder:text-sm hover:border-filter-stroke',
    secondary:
