...
const FunctionCards = () => {
    return (
        <div className="flex h-[calc(100vh-5rem)] grid grid-rows-3 mr-10 ml-10">
            <article className="bg-white row-span-1 rounded-xl p-3 flex flex-row mb-3 drop-shadow-md">
            ...
            <article className="bg-white row-start-2 rounded-xl p-3 flex flex-row mb-3 drop-shadow-md">
            ...
            <article className="bg-white row-start-3 rounded-xl p-3 flex flex-row mb-6 drop-shadow-md">
                ...
                <div className="flex-1">
                    <p className="flex text-yellow-950 text-5xl mt-7 ml-2 drop-shadow-sm"> Donate Service </p>
                    <p className="flex text-yellow-950 text-4xl mt-4 ml-2 drop-shadow-sm"> Volunteer your time and talent to the community. </p>
                </div>
            </article>
        </div>
    );
